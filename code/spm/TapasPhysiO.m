...
matlabbatch{1}.spm.tools.physio.scan_timing.sqpar.onset_slice = slice_ref;
...
matlabbatch{1}.spm.tools.physio.preproc.cardiac.initial_cpulse_select.auto_matched.min = 0;
...
%% CompCor method is now running with nypipe
